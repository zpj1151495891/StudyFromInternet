...
public class HTMLLayoutOverride extends HTMLLayout{
	
	public HTMLLayoutOverride() {
	}
	...
	public String format(LoggingEvent event) {
		...
		if (locationInfo) {
			...
			sbuf.append(Transform.escapeTags(locInfo.getClassName()));
			sbuf.append(".");
			sbuf.append(Transform.escapeTags(locInfo.getMethodName()));
			sbuf.append(':');
	...
	public String getHeader() {
		...
		sbuf.append("<th>发生时间</th>" + Layout.LINE_SEP);
		sbuf.append("<th>错误级别</th>" + Layout.LINE_SEP);
